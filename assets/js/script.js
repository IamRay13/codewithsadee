...
const musicData = [
 {
  ...
  },
  {
    ...
    musicPath: "./assets/music/JericMaeChen.mp3",
      ...
      {
    backgroundImage: "./assets/images/NAME.jpg",
    posterUrl: "./assets/images/NAME.jpg",
    title: "NAME",
    album: "NAME",
    year: NUMBER,
    artist: "NAME",
    musicPath: "./assets/music/1735305015.0189097_spotymate.com.mp3",
  },
     {
    backgroundImage: "./assets/images/Hinder - Lips of An Angel (Lyrics).jpg",
    posterUrl: "./assets/images/Hinder - Lips of An Angel (Lyrics).jpg",
    title: "Lips of an Angel",
    album: "Lips of an Angel",
    year: 19XX,
    artist: "Hinder",
    musicPath: "./assets/music/Hinder - Lips of An Angel (Lyrics).mp3",
  },
     {
    ...
    musicPath: "./assets/music/Lady Gaga, Bruno Mars - Die With A Smile (Official Music Video).mp3",
     ...
     {
    backgroundImage: "./assets/images/Mahal Pa Rin Kita.jpg",
    posterUrl: "./assets/images/Mahal Pa Rin Kita.jpg",
    title: "Mahal Pa Rin Kita",
    album: "Mahal Pa Rin Kita",
    year: 19XX,
    artist: "Harmonica Band ft. Justine Calucin.",
    musicPath: "./assets/music/Mahal Pa Rin Kita- (ByRockstar)Harmonica Band ft. Justine Calucin.mp3",
  },
     {
    backgroundImage: "./assets/images/Television So Far So Good.jpg",
    posterUrl: "./assets/images/Television So Far So Good.jpg",
    title: "Television So Far So Good",
    album: "Television So Far So Good",
    year: 19XX,
    artist: "Rex Orange County",
    musicPath: "./assets/music/Rex Orange County - Television So Far So Good (Official Audio).mp3",
  },
     {
    ...
    musicPath: "./assets/music/The Kid LAROI, Justin Bieber - Stay (Acoustic) (Music Video).mp3",
  },
    {
